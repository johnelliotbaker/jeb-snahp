...
Mydramalist.makeMydramalistTemplate = function(data)
{
    ...
    var status         = getEntryOrEmpty(`[color=#FF8000][b]Status[/b][/color]: {text}\n`, status);
    var aired_start    = getEntryOrEmpty(`[color=#FF8000][b]Start[/b][/color]: {text}\n`, aired_start);
    var aired_end      = getEntryOrEmpty(`[color=#FF8000][b]Finish[/b][/color]: {text}\n`, aired_end);
    var country        = getEntryOrEmpty(`[color=#FF8000][b]Country[/b][/color]: {text}\n`, country);
...
Mydramalist.updateMydramalistPosters = function(media)
{
    ...
    $('<a href="#mydramalist_dialog" id="modalTriggerLink"></a>').appendTo($("body"));
    setTimeout(function(){
...
{
    $mydramalist_dialog = $(Mydramalist.mydramalist_dialog_template).appendTo($("body"));
    $mydramalist_dialog = $("#mydramalist_dialog");
    $mydramalist_header = $("#mydramalist_header");
    $mydramalist_title  = $("#mydramalist_title").text(`Results for "${searchTerm}"`);
