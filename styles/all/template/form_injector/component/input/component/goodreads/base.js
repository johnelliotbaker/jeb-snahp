...
Goodreads.makeTemplate = function(data)
{
  ...
  var averageRating = getEntryOrEmpty(`[size=108][b]{text}[/b] / [b]5[/b][/size] (based on [b]${ratingsCount}[/b] ratings)\n`, averageRating);
  var categories    = getEntryOrEmpty(`[b][size=140]{text}[/size][/b]\n`, joinArrayOrEmpty(categories, ', '));
  ...
  var text = '[center]\n' + 
    ...
    hidebox + '[/center]\n\n\n' +
    description + '\n' +
    publishedDate + publisher + language + pageCount + isbn + '\n';
