...
!(function (t, e) {
...
})("undefined" != typeof self ? self : this, function (t, g, u) {
  "use strict";
  function i(t, e) {
  ...
  (g.fn[pe] = Ue._jQueryInterface),
    ...
    (g.fn[pe].noConflict = function () {
      return (g.fn[pe] = Ee), Ue._jQueryInterface;
    });
  var We = "popover",
    xe = "bs.popover",
    Fe = "." + xe,
  ...
  var yn = "bs.tab",
    ...
    Hn = (function () {
      ...
      return (
        ...
        (t.dispose = function () {
          g.removeData(this._element, yn), (this._element = null);
        }),
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            var t = g(this),
              e = t.data(yn);
            if (
              (e || ((e = new i(this)), t.data(yn, e)), "string" == typeof n)
            ) {
