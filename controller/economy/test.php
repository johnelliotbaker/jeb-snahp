...
class test extends base
{
    ...
    public function handle($mode)
    {
        ...
        switch ($mode) {
            ...
            case "transactions":
                $cfg["tpl_name"] =
                    "@jeb_snahp/bank/component/transactions/base.html";
    ...
    {
        return (int) $this->market_helper->get_total_cost(
            $product_class_id,
            $quantity
        );
    }
    ...
    private function can_buy($required_quantity, $product_class_id, $user_id)
    {
        ...
        $inv_data = $this->user_inventory_helper->get_single_inventory(
    ...
    public function handle_buy_product($cfg)
    {
        ...
        $b_bank = $bank->create_transaction_and_withdraw(
            $total_cost,
            $user_id,
            $broker_id,
            $comment
    ...
    public function handle_exchange($cfg)
    {
        ...
        [$b_success, $reason] = $this->bank_helper->perform_exchange(
            $exchange_rate_id,
            $direction,
            $amount
        );
    ...
    public function handle_transactions($cfg)
    {
        ...
        $transaction_history = $this->bank_helper->get_transaction_history(
            $user_id
        );
