...
class analytics extends base
{
    ...
    public function handle($mode)
    {
        switch ($mode) {
            case "stats":
                $cfg["tpl_name"] =
                    "@jeb_snahp/analytics/component/stats/base.html";
    ...
    private function select_monthly_stats()
    {
        ...
        $data = [
            ...
            "DESCRIPTION" =>
                "Number of unique users visited in the last 30 days.",
