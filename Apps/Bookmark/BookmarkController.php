        ...
        switch ($method = $this->request->server("REQUEST_METHOD")) {
            ...
            case "POST":
                $url = htmlspecialchars_decode(
                    $this->request->variable("url", "")
                );
                $params = htmlspecialchars_decode(
                    $this->request->variable("params", "")
                );
                $hash = htmlspecialchars_decode(
                    $this->request->variable("hash", "")
                );
                $name = htmlspecialchars_decode(
                    $this->request->variable("name", "")
                );
                try {
                    $results = $this->helper->saveUserBookmark(
                        $userId,
                        $type,
                        $url,
                        $params,
