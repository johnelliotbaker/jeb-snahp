...
class AchievementsEventListener implements EventSubscriberInterface
{
    ...
    {
        return [
            "core.viewtopic_cache_user_data" => [["setUserAchievementData", 1]],
            "core.viewtopic_modify_post_row" => [["setPosterAchievements", 1]],
        ];
    }
    ...
    public function setUserAchievementData($event)
    {
        ...
        $userCacheData["achievements"] = $this->helper->getAchievements(
            $posterId
        );
