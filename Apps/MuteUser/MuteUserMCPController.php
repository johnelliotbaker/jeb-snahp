...
class MuteUserMCPController
{
    ...
    public function handle($mode)
    {
        ...
        trigger_error(
            "Nothing to see here. Move along. Error Code: b586a44968"
        );
    }

    private function _makePagination()
    {
        $baseUrl = $this->helper->route("jeb_snahp_routing.mute_user", [
            "mode" => "manage",
        ]);
        // Pagination
    ...
    public function respondMuteUser($cfg)
    {
        ...
        $action = $this->helper->route("jeb_snahp_routing.mute_user", [
            "mode" => "manage",
        ]);
