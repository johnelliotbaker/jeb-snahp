...
class RequestFormEventListener implements EventSubscriberInterface
{
    ...
    public static function getSubscribedEvents()
    {
        return [
            ...
            "core.modify_posting_parameters" => [["setPostingVars", 1]],
            "core.posting_modify_template_vars" => [["embedCustomForm", 1]],
            "core.viewtopic_modify_post_row" => [["embedRequestTemplate", 1]],
            ...
            "core.posting_modify_submit_post_before" => [["tagTopicTitle", 1]],
        ];
    }
    ...
    public function setPostingVars($event)
    {
        ...
        $this->data["posting"]["requestForumName"] = getRequestForumName(
            $forumId
        );
    }
    ...
    public function setTopicVars($event)
    {
        ...
        $this->data["topic"]["requestForumName"] = getRequestForumName(
            $forumId
        );
    }
