...
namespace RedBeanPHP\QueryWriter {
    ...
    abstract class AQueryWriter
    {
        ...
        public function queryRecursiveCommonTableExpression(
			...
			SELECT " .
                    ($count ? "count(redbeantree.*)" : "redbeantree.*") .
                    " FROM redbeantree {$sql};",
                $bindings
            );
            return $rows;
        }
...
namespace RedBeanPHP {
    ...
    class Finder
    {
         ...
         * @return OODBBean
         */
        public function findOrCreate($type, $like = [], $sql = "")
        {
            $sql = $this->toolbox->getWriter()->glueLimitOne($sql);
...
namespace RedBeanPHP {
    ...
    class Facade
    {
         ...
         * @return OODBBean
         */
        public static function findOrCreate($type, $like = [], $sql = "")
        {
