...
class pagination
{
    ...
    public function makejs(
        ...
        $html .=
            '<li class="page-item noselect"><a class="page-link" href="#">Previous</a></li>';
        ...
        $html .=
            '<li class="page-item noselect"><a class="page-link" href="#">Next</a></li>';
        $html .= "</ul></nav>";
        return $html;
    }
    ...
    private function get_start($total, $per_page, $i_block, $base_url)
    {
        ...
        $url =
            $base_url . "${prepend_char}per_page={$per_page}&start={$i_start}";
        $data = [
            "block" => 1,
            "index" => $i_start,
        ];
        if ($i_block <= $block_start) {
            $html =
                '<li class="page-item noselect"><span class="page-link" style="cursor: default;">&nbsp;</span></li>';
        } else {
            $html =
                '<li class="page-item noselect"><a class="page-link" href="' .
                $url .
                '">' .
                $block_start .
                "</a></li>";
    ...
    private function get_prev(
        ...
        if ($i_block <= $block_start) {
            $html =
                '<li class="page-item noselect"><span class="page-link" style="cursor: default;">Prev</span></li>';
        } else {
            $html =
                '<li class="page-item noselect"><a class="page-link" href="' .
                $url .
    ...
    private function get_next($total, $per_page, $i_block, $n_block, $base_url)
    {
        ...
        if ($i_block >= $block_end) {
            $html =
                '<li class="page-item noselect"><span class="page-link" style="cursor: default;">Next</span></li>';
        } else {
            $html =
                '<li class="page-item noselect"><a class="page-link" href="' .
                $url .
