...
class v_0_38_0 extends container_aware_migration
{
            ...
            "add_tables" => [
                ...
                $this->table_prefix . "miniboard_minitopics" => [
                    "COLUMNS" => [
                        ...
                        $this->table_prefix . "miniboard_miniforums_id" => [
                            "INT:11",
                            0,
                        ],
                    ],
    ...
    public function set_utf8mb4()
    {
        ...
        $sql =
            "ALTER TABLE " .
            $table_prefix .
            "miniboard_miniforums CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci";
        $db->sql_query($sql);
        $sql =
            "ALTER TABLE " .
            $table_prefix .
            "miniboard_minitopics CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci";
        $db->sql_query($sql);
    }
